    ...
    <div className=" mx-auto p-4">
      ...
      >
        ...
        <p className="mt-4 text-lg text-gray-700">
          Whether you're here for a routine touch-up or a complete makeover, our
          professional team is here to provide you with a customized experience
      ...
      <section className="mb-8">
        ...
        <p className="text-lg text-gray-700 mb-4">
          Meet our team of experts, each with a passion for beauty and a
          dedication to helping you feel your best. From experienced stylists to
          certified skincare professionals, our team is here to offer top-tier
          service and make your salon experience truly special.
        </p>
        <ul className="list-inside text-gray-700">
          <li>
            <strong>Lisa</strong> - Master Stylist with over 10 years of
            experience in hair design and color treatments.
          </li>
          <li>
            <strong>Rose</strong> - Licensed aesthetician specializing in
            facials, skin treatments, and waxing.
          </li>
        </ul>
      </section>
